       ...
       <div class="row">
                                <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-6">
                                                ...
                                                <label for="name" class="control-label">Type Property</label>
                                                    <input type="text" class="form-control" id="customer_type_property" name="customer_type_property" placeholder="Enter Type" value="" maxlength="50" required="" >
                                                </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                   ...
                   <div class="row" style="margin-top: 20px;">                           
                                  ...
                                  <!--      <div class="col-sm-2">
                                        ...
                                        <div class="col-sm-12">
                                            <div  class="row overflow-auto"  style="overflow-y:auto !important;min-height: 25vh;max-height: 50vh;" >
                                                 <table id="itemx"  width="100%" style=" width:100%; text-aling:center; ">
                           ...
                           <div class="row">                     
                                     ...
                                     <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"  id="partial_payment_montc" name="partial_payment_montc" aria-label="Amount (to the nearest dollar)" value="0,00" >
...
var count = $("#ItemForm fieldset").length;
 ...
 function listpaid(id){
    ...
    function listItem(id){
        ...
        $.get("{{ route('billservises.index') }}" +'/' + id +'/edit', function (data) {  //   console.log('data:', data);
          for(var i = 0; i < data.length; i++) {           
            var out;    
                    out = '<tr>';
                    out += '<th style="text-align: center; width:5%;"> <input type="hidden"  value="' + data[i].id + '" name="id_tb[]" id="id_tb[]"/><input type="text" class="form-control " id="serv_id[]" name="serv_id[]"  value="' + data[i] .services_id + '" maxlength="50" required="" readonly></div> </div> ';
                    out += '<th style="text-align: center; width:15%;"><input type="text" class="form-control " id="serv_name[]" name="serv_name[]"  value="' + data[i] .serv_name + '" maxlength="50" required="" ></div> </div>';
                    out += '<th style="text-align: center; width:20%;">  <input type="text" class="form-control " id="serv_description[]" name="serv_description[]"  value="' + data[i] .serv_description + '" maxlength="50" required=""  ></div> </div>';
                    out += '<th style="text-align: center; width:10%;"> <input type="text" class="form-control " id="serv_qty[]" name="serv_qty[]"  value="' + data[i] .serv_qty + '" maxlength="50" required="" readonly></div> </div>';
                    out += '<th style="text-align: center; width: 11%;"> <input type="text" class="form-control " id="serv_unit[]" name="serv_unit[]"  value="' + data[i].serv_unit + '" maxlength="50" required="" ></div> </div>';
                    out += '<th style="text-align: center; width: 7%;">  <input type="text" class="form-control " id="serv_price[]" name="serv_price[]"  value="' + data[i].serv_price  + '" maxlength="50" required="" readonly></div> </div>';
                    out += '<th style="text-align: center; width: 7%;">  <input type="text" class="form-control itemsx" id="serv_total_prices[]" name="serv_total_prices[]"  value="' + data[i] .serv_total_prices + '" maxlength="50" required="" readonly> </div> </div>';
                    out += '<th style="text-align: center; width: 4%;"> <a href="javascript:void(0)" data-toggle="tooltip"  data-idX="' + data[i].id + '" data-original-title="Delete" class="btn btn-danger btn-sm remove_button">x</a> </div> </div>';
                    out += '</tr>';
             $('#itemx').append(out);   
          }         
      });
   ...
   /*  select = document.getElementById("discount3");
        for(i = 0; i <= 100; i++){
            option = document.createElement("option");
            option.value = i;
            option.text = i;
       ...
       select = document.getElementById("partial_payment_percents");
        for(i = 29; i <= 100; i++){
            option = document.createElement("option");
            option.value = i;
            option.text = i;
    ...
    function calcular_total(){
       ...
       var totalformat = new Intl.NumberFormat('de-DE',{  minimumFractionDigits: 2,  maximumFractionDigits: 2 }).format(totalx);
        ...
        $.get("{{url('/')}}/services/show", function (data) {  
          for(var i = 0; i < data.length; i++) {
...
//partial_pay_total_cash();
   ...
   $('.additems').click(function () {
    ...
    $('#addBtn').click(function (e) {
        ...
        var out;          
             out = '<tr>';             
             out += '<th style="text-align: center; width:5%;"> <input type="hidden"  value="" name="id_tb[]" id="id_tb[]"/><input type="text" class="form-control" id="serv_id[]" name="serv_id[]"  value="' +item1 + '" maxlength="50" required="" readonly></th>> ';
             out += '<th style="text-align: center; width:15%;"> <input type="text" class="form-control" id="serv_name[]" name="serv_name[]"  value="' + item2 + '" maxlength="50" required="" ></th>';
             out += '<th style="text-align: center; width:20%;"> <input type="text" class="form-control" id="serv_description[]" name="serv_description[]"  value="' + item3 + '" maxlength="50" required="" ></th>';
             out += '<th style="text-align: center; width:10%;"> <input type="text" class="form-control" id="serv_qty[]" name="serv_qty[]"  value="' + item4 + '" maxlength="50" required="" readonly></th>';
             out += '<th style="text-align: center; width: 11%;">  <input type="text" class="form-control" id="serv_unit[]" name="serv_unit[]"  value="' + item7 + '" maxlength="50" required="" ></th>';
             out += '<th style="text-align: center; width: 7%;">  <input type="text" class="form-control" id="serv_price[]" name="serv_price[]"  value="' + item5 + '" maxlength="50" required="" readonly></th>';
             out += '<th style="text-align: center; width: 7%;">  <input type="text" class="form-control itemsx" id="serv_total_prices[]" name="serv_total_prices[]"  value="' +item6 + '" maxlength="50" required="" readonly></th>';
             out += '<th style="text-align: center; width: 4%;">  <a href="javascript:void(0)" data-toggle="tooltip"  data-idX="' + item1+ '" data-original-title="Delete" class="btn btn-danger btn-sm remove_buttonx">x</a> </th>';
             out += '</tr>';
             $('#itemx').append(out);  
             // $('#ItemForm').trigger("reset");
        ...
        $.ajax({
          ...
          success: function (data) {    
           // console.log('Exito:', data); 
              ...
              var out;          
                out = '<tr>';
                out += '<th style="text-align: center; width:5%;"> <input type="hidden"  value="" name="id_tb[]" id="id_tb[]"/><input type="text" class="form-control" id="serv_id[]" name="serv_id[]"  value="' +data.id + '" maxlength="50" required="" readonly></th> ';
                out += '<th style="text-align: center; width:15%;"> <input type="text" class="form-control" id="serv_name[]" name="serv_name[]"  value="' + data.name + '" maxlength="50" required="" ></th>';
                out += '<th style="text-align: center; width:20%;"> <input type="text" class="form-control" id="serv_description[]" name="serv_description[]"  value="' + data.description + '" maxlength="50" required="" ></th>';
                out += ' <th style="text-align: center; width:10%;"> <input type="text" class="form-control" id="serv_qty[]" name="serv_qty[]"  value="' + item1 + '" maxlength="50" required="" readonly></th>';
                out += ' <th style="text-align: center; width: 11%;"> <input type="text" class="form-control" id="serv_unit[]" name="serv_unit[]"  value="' + data.unit + '" maxlength="50" required="" ></th>';
                out += '<th style="text-align: center; width: 7%;"> <input type="text" class="form-control" id="serv_price[]" name="serv_price[]"  value="' + data.prices + '" maxlength="50" required="" readonly></th>';
                out += '<th style="text-align: center; width: 7%;"><input type="text" class="form-control itemsx" id="serv_total_prices[]" name="serv_total_prices[]"  value="' +item2 + '" maxlength="50" required="" readonly> </th>';
                out += '<th style="text-align: center; width: 4%;"><a href="javascript:void(0)" data-toggle="tooltip"  data-idX="' + data.id+ '" data-original-title="Delete" class="btn btn-danger btn-sm remove_buttonx">x</a> </th>';
                out += '</tr>';
             $('#itemx').append(out); 
             Swal.fire("item added successfully", "", "success");
             update_total();
