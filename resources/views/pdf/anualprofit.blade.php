...
<page backtop="64.33mm" backbottom="2mm" backleft="1mm" backright="1mm" backimg="https://bill.greendepartment.org/image/anual.png"  backimgy="top" 	>
<page_header>
...
<table border="0" cellspacing="0" cellpadding="0" class="page_header"   style="width: 100%; border:none;">
 ...
 <tr>
   <td></td>
   <td style="color:#000; text-align:center; border:0px solid #000;"><h1>Annual Billing Report {{$comparacion['ano1']}}</h1></td>
   <td></td>
 </tr>
        ...
        <tr>
          ...
          <table  cellspacing="0" cellpadding="0"  id="tepeint" style="border-collapse: collapse;  border:1px solid #000;">
                ...
                <tr>
                    ...
                    <col class="table-bordered" style="width: 33.33%;">
                    <tr>
                        <td style="color:#fff; font-size:18px; border:0px solid #000;"><div style="margin-top:0px;">@money($comparacion['previo'])<br><span style='font-size:12px;'> Total profit {{$comparacion['ano2']}}</span></div></td>
                        <td style="color:#fff; font-size:18px; border:0px solid #000;"><div style="margin-top:0px;">&nbsp;@money($comparacion['anterior'])<br>&nbsp;<span style='font-size:12px;'> Total profit {{$comparacion['ano1']}} </span>  </div></td>
                        <td style="color:#fff; font-size:18px; border:0px solid #000;"><div style="margin-top:0px;">&nbsp;&nbsp;&nbsp;@comver($comparacion['diferencia']) % <br>&nbsp;&nbsp;&nbsp;<span style='font-size:12px; padding-left:160px; display:block;'>Profit according to<br>&nbsp;&nbsp; &nbsp; the previous year</span></div></td>    
                    </tr>                      
                    </table>
                    </td>
                    <td style="color:#fff; font-size:30px; border:0px solid #000;"></td>
                ...
                <tr>
                    ...
                    <td style="color:#000; font-size:15px; border:0px solid #000; text-align:center;"><h3>Earnings per Month for 2020</h3></td>
                    <td style="color:#fff; font-size:13px; border:0px solid #000;"></td>
                </tr>  
                <tr>
