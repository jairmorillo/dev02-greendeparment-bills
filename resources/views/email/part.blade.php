...
<center>
 <table borde="0" style="border-collapse: collapse ; width:600px; font-family:Arial;" >
	...
	<td colspan="3" style="text-align:center;font-size:1.2em;"><br>
		<h1>Hello,<b> {{ $data->customer_name }} </b></h1>This is the billing department of the <b>Green Department INC</b>,<h3><b>Thank you for trusting us</b></h3>, we have received partial payment for 
		<b>		  
	    	@if ( $data->partial_payment_cash === '0,00' )
                  {{ $data->partial_payment_percents }}% 
             @else 
			  $ {{ $data->partial_payment_cash }} 
            @endif   
		</b>  the services provided.
		
		 <br> If you want to see the invoice, click on the button.
	</td>
	</tr>
